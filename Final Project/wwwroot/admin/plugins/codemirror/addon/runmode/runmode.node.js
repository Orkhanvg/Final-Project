...
require.cache[require.resolve("~/admin/lib/codemirror")] = require.cache[require.resolve("./runmode.node")];
require.cache[require.resolve("~/admin/addon/runmode/runmode")] = require.cache[require.resolve("./runmode.node")];
...
(function(mod) {
  if (typeof exports == "object" && typeof module == "object") // CommonJS
    { mod(require("~/admin/lib/codemirror")); }
  else if (typeof define == "function" && define.amd) // AMD
    { define(["~/admin/lib/codemirror"], mod); }
